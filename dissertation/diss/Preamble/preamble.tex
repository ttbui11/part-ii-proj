...
%\usepackage{chngcntr} % continuous count -- incorporated into Mactex latest. Uncomment gives an error.
...
\titlespacing*{\section}{0pt}{0.75ex}{0.75ex}
\titlespacing*{\subsection}{0pt}{0.5ex}{0.5ex}
\titlespacing*{\subsubsection}{0pt}{0.25ex}{0.25ex}